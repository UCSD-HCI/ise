...
#Region "--> File IO "
	...
	Friend Shared Function CreateFile(ByVal lpFileName As String, ByVal dwDesiredAccess As Integer, ByVal dwShareMode As Integer, ByRef lpSecurityAttributes As SECURITY_ATTRIBUTES, ByVal dwCreationDisposition As Integer, ByVal dwFlagsAndAttributes As Integer, ByVal hTemplateFile As IntPtr) As Integer
	End Function
	...
	<DllImport("kernel32.dll", SetLastError:=True)> _
	Friend Shared Function WriteFile(ByVal hFile As IntPtr, ByVal lpBuffer As Byte(), ByVal nNumberOfBytesToWrite As Integer, ByRef lpNumberOfBytesWritten As Integer, ByRef lpOverlapped As NativeOverlapped) As Boolean
	End Function
...
#Region "--> Device Management "
	...
	Friend Shared Function SetupDiGetDeviceRegistryProperty(ByVal DeviceInfoSet As IntPtr, ByRef DeviceInfoData As SP_DEVINFO_DATA, ByVal PropertyVal As Integer, ByRef PropertyRegDataType As Integer, ByVal PropertyBuffer As Byte(), ByVal PropertyBufferSize As Integer, ByRef RequiredSize As Integer) As Boolean
	End Function
	...
	Friend Shared Function SetupDiGetClassDevs(ByRef ClassGuid As System.Guid, <MarshalAs(UnmanagedType.LPTStr)> ByVal Enumerator As String, ByVal hwndParent As IntPtr, ByVal Flags As UInteger) As IntPtr
	End Function
...
#Region "--> HID "
	...
	<DllImport("hid.dll")> _
	Public Shared Sub HidD_GetHidGuid(ByRef HidGuid As System.Guid)
	End Sub
